...
class Heal( BaseEntity ):
    def __init__( self, app, name='heal', pos=( 0, 0 )): 
        ...
        self.speed = 0.7
        self.heal_direction = vec2( 0, -self.speed )
    ...
    def run( self ):
        heal_direction = self.heal_direction * self.app.delta_time
        self.pos += heal_direction.rotate_rad( -self.angle ) - self.player.inc
